...
import '../../Bloc/pays_bloc.dart';
import '../../DAO/bibliotheque_dao.dart';
import '../../Model/Pays.dart';
import '../../main.dart';
import 'ShowOuvrage.dart';
...
class _ListeOuvragesState extends State<ListeOuvrages> {
  ...
  void delete(Ouvrage ouvrage) {
    ...
    var data = bibliothequeDao.getBibliotheques(ouvrage: ouvrage.ISBN).then((value) {
      print('value $value');
      if (value == false){
        ouvrageBloc.deleteOuvrageById(ouvrage.ISBN);
      }else{
